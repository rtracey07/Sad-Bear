...
public class PlayerController : MonoBehaviour {
	...
	//Check to see whether the player has fallen too far.
	void CheckYBound()
	{
		//Respawn player when out of y boundary.
